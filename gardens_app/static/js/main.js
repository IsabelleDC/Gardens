    ...
    var rssReader = {
        ...
        init: function (selector) {
            ...
            for (i = 0; i < containers.length; i++) {
                ...
                var googUrl = 'https://ajax.googleapis.com/ajax/services/feed/load?v=1.0&num=' + num + '&q=' + url + '&callback=rssReader.parse&context=' + AIzaSyA7qcazmIFHUpdsEWLD4kd7NY9xU4rlPm0";
